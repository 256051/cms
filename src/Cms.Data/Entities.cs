...
public abstract class Entity
{
    ...
    [Column(IsPrimary = true, StringLength = 32)] public string Id { get; set; } = Guid.NewGuid().ToString("N");
    /// <summary>UTC creation timestamp.</summary>
    public DateTime CreatedAt { get; set; } = DateTime.UtcNow;
}

/// <summary>Administrator or editor account.</summary>
[Table(Name = "cms_users"), Index("ux_user_name", nameof(Username), true)]
public class CmsUser : Entity
{
    /// <summary>Normalized login name.</summary>
    [Column(StringLength = 64)] public string Username { get; set; } = "";
    /// <summary>Display name.</summary>
    [Column(StringLength = 100)] public string DisplayName { get; set; } = "";
    /// <summary>ASP.NET password hash.</summary>
    [Column(StringLength = 512)] public string PasswordHash { get; set; } = "";
    /// <summary>Admin or Editor role.</summary>
    [Column(StringLength = 16)] public string Role { get; set; } = "Editor";
    /// <summary>Whether login is allowed.</summary>
    public bool Enabled { get; set; } = true;
    /// <summary>Revokes existing cookies after account changes.</summary>
    [Column(StringLength = 32)] public string SecurityStamp { get; set; } = Guid.NewGuid().ToString("N");
}

/// <summary>Editorial content with a separate public snapshot.</summary>
[Table(Name = "cms_content"), Index("ux_content_slug", nameof(Slug), true)]
public class Content : Entity
{
    /// <summary>post or page.</summary>
    [Column(StringLength = 16)] public string Kind { get; set; } = "post";
    ...
    [Column(StringLength = 500)] public string Summary { get; set; } = "";
    /// <summary>Sanitized draft HTML.</summary>
    [Column(StringLength = -2)] public string Html { get; set; } = "";
    /// <summary>Optional cover identifier.</summary>
    [Column(StringLength = 32)] public string CoverId { get; set; } = "";
    /// <summary>Optional category.</summary>
    [Column(StringLength = 32)] public string CategoryId { get; set; } = "";
    /// <summary>Pipe-delimited tag identifiers.</summary>
    [Column(StringLength = 1500)] public string TagIds { get; set; } = "";
    ...
    [Column(StringLength = -2)] public string PublishedJson { get; set; } = "";
    /// <summary>Published title used for queries.</summary>
    [Column(StringLength = 200)] public string PublishedTitle { get; set; } = "";
    /// <summary>Published summary used for queries.</summary>
    [Column(StringLength = 500)] public string PublishedSummary { get; set; } = "";
    /// <summary>Published category used for archives.</summary>
    [Column(StringLength = 32)] public string PublishedCategoryId { get; set; } = "";
    /// <summary>Published tags used for archives.</summary>
    [Column(StringLength = 1500)] public string PublishedTagIds { get; set; } = "";
    /// <summary>Most recent publication time.</summary>
    public DateTime? PublishedAt { get; set; }
}

/// <summary>A category or tag.</summary>
[Table(Name = "cms_taxonomy"), Index("ux_taxonomy_slug", "Kind,Slug", true)]
public class Taxonomy : Entity
{
    /// <summary>category or tag.</summary>
    [Column(StringLength = 16)] public string Kind { get; set; } = "category";
    /// <summary>Visible label.</summary>
    [Column(StringLength = 100)] public string Name { get; set; } = "";
    /// <summary>Archive URL segment.</summary>
    [Column(StringLength = 100)] public string Slug { get; set; } = "";
}
...
public class Asset : Entity
{
    ...
    [Column(StringLength = 100)] public string ContentType { get; set; } = "";
    /// <summary>Generated disk filename.</summary>
    [Column(StringLength = 80)] public string StorageName { get; set; } = "";
...
public class Comment : Entity
{
    ...
    [Column(StringLength = 60)] public string Author { get; set; } = "";
    /// <summary>Plain text only.</summary>
    [Column(StringLength = 2000)] public string Body { get; set; } = "";
...
{
    /// <summary>Visible label.</summary>
    [Column(StringLength = 200)] public string Label { get; set; } = "";
    /// <summary>Safe relative or HTTPS address.</summary>
    [Column(StringLength = 500)] public string Url { get; set; } = "/";
    /// <summary>Ascending display order.</summary>
    public int Sort { get; set; }
    /// <summary>Empty for a top-level item.</summary>
    [Column(StringLength = 32)] public string ParentId { get; set; } = "";
    /// <summary>Custom link, post, page, category or tag.</summary>
    [Column(StringLength = 16)] public string Type { get; set; } = "custom";
...
public class SiteSettings : Entity
{
    ...
    [Column(StringLength = 100)] public string Title { get; set; } = "我的内容站";
    /// <summary>Website introduction.</summary>
    [Column(StringLength = 500)] public string Description { get; set; } = "记录想法，分享值得阅读的内容。";
    /// <summary>Logo asset identifier.</summary>
    [Column(StringLength = 32)] public string LogoId { get; set; } = "";
    /// <summary>SEO keywords.</summary>
    [Column(StringLength = 300)] public string Keywords { get; set; } = "";
    /// <summary>Short introduction displayed with the site identity.</summary>
    [Column(StringLength = 100)] public string Subtitle { get; set; } = "";
    /// <summary>Browser icon asset identifier.</summary>
    [Column(StringLength = 32)] public string FaviconId { get; set; } = "";
    /// <summary>Primary content language, not an interface translation setting.</summary>
    [Column(StringLength = 16)] public string Language { get; set; } = "zh-CN";
    ...
    [Column(StringLength = 500)] public string FooterText { get; set; } = "";
...
public class AuditEntry : Entity
{
    ...
    [Column(StringLength = 120)] public string Action { get; set; } = "";
    /// <summary>Stable kind of the affected business object; blank on historical v1 entries.</summary>
    [Column(StringLength = 24)] public string TargetType { get; set; } = "";
...
public class ThemeState : Entity
{
    ...
    [Column(StringLength = 32)] public string ActiveThemeId { get; set; } = "classic";
    /// <summary>Per-theme options as portable text, never executable templates.</summary>
    [Column(StringLength = -1)] public string ProfilesJson { get; set; } = "{}";
